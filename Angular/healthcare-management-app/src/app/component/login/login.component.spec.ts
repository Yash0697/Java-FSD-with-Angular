...
describe('LoginComponent', () => {
  ...
  beforeEach(() => {
    ...
    errorAlertNoUsername =
      fixture.nativeElement.querySelector('#error-no-username');
    errorAlertNoPassword =
      fixture.nativeElement.querySelector('#error-no-password');
  ...
  it('should display no username validation error when the field kept as null(dirty)', fakeAsync(() => {
    fixture.whenStable().then(() => {
      ...
      const elemInput: HTMLInputElement =
  ...
  it('should enable login button(form valid) when both field are valid', fakeAsync(() => {
    fixture.whenStable().then(() => {
      usernameCtrl = component.loginForm.controls['userName'];
      const elemInput1: HTMLInputElement =
        fixture.nativeElement.querySelector('#username');
      elemInput1.value = 'xxx12';
      elemInput1.dispatchEvent(new Event('input'));
      passwordCtrl = component.loginForm.controls['password'];
      const elemInput2: HTMLInputElement =
        fixture.nativeElement.querySelector('#password');
