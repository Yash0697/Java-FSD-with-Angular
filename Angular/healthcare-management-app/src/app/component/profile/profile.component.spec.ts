...
describe('ProfileComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ProfileComponent, MockComponent],
  ...
  it('should display profile details on load', fakeAsync(() => {
    ...
    fixture.whenStable().then(() => {
      elemEditProfileBtn =
        fixture.nativeElement.querySelector('#editProfileBtn');
      const elemProfileDetails =
        fixture.nativeElement.querySelector('#profileDetails');
      component.ngOnInit();
  ...
  it('should display edit profile form on edit profile button click', () => {
    ...
    const elemEditProfileForm =
      fixture.nativeElement.querySelector('#editProfileForm');
    const elemProfileDetails =
      fixture.nativeElement.querySelector('#profileDetails');
    fixture.detectChanges();
  ...
  it('should populate form fields with values on edit profile button click', fakeAsync(() => {
    ...
    fixture.whenStable().then(() => {
      ...
      elemEditDiscardBtn =
        fixture.nativeElement.querySelector('#editDiscardBtn');
      const elemEditProfileForm =
        fixture.nativeElement.querySelector('#editProfileForm');
  ...
  it('should submit profile changes with validation', fakeAsync(() => {
    const userId = spyOn(dataService, 'getUserId').and.returnValue(1);
    const updateProfileResponse = spyOn(
      dataService,
      'updateProfile'
    ...
    fixture.whenStable().then(() => {
      ...
      const elemEditSubmitBtn =
        fixture.nativeElement.querySelector('#editSubmitBtn');
      fixture.detectChanges();
  ...
  it('#getProfileDetails should return error on occurence of error', fakeAsync(() => {
    spyOn(dataService, 'getUserDetails').and.returnValue(
